        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              ...
              AnimatedTextKit(
                animatedTexts: [
                  TypewriterAnimatedText('Flutter Developer',
                      textStyle: TextStyle(
                          fontSize:
                              CustomDeviceType.isMobile(context) ? 30 : 40,
                          fontWeight: FontWeight.bold,
              ...
              Row(
                children: [
                  SvgPicture.asset(height: 40,width: 40, Assets.facebookIcon),
                  xWidth(10),
                  SvgPicture.asset(height: 40,width: 40, Assets.instagramLogo),
                  xWidth(10),
                  SvgPicture.asset(height: 40,width: 40, Assets.whatsappIcon),
                  xWidth(10),
                ],
              ),
              yHeight(20),
